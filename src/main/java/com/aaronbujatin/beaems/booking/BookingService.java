...
public class BookingService {
    ...
    private void sendEmail(Booking booking) throws MessagingException {
        ...
        String emailText = "Dear " + booking.getClientName() + ",\n\n" +
                ...
                "Please schedule this meeting by " + meetingDeadline +" to avoid any inconvenience. If we do not receive a confirmation of your payment and a meeting scheduled by this deadline, we will regretfully have to nullify your reservation.\n\n" +
